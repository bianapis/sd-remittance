...
/**
 * TransactionUpdateBaseWithIdAndRoot
 */
public class TransactionUpdateBaseWithIdAndRoot   {
  private String transactionUpdateReference = null;
  ...
  private String transactionUpdateResult = null;


  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier      
   * @return transactionUpdateReference
  **/

  public String getTransactionUpdateReference() {
    return transactionUpdateReference;
  }

  public void setTransactionUpdateReference(String transactionUpdateReference) {
  ...
  **/
  ...
  public String getTransactionUpdateResult() {
    return transactionUpdateResult;
  }

  public void setTransactionUpdateResult(String transactionUpdateResult) {
    this.transactionUpdateResult = transactionUpdateResult;
  }
